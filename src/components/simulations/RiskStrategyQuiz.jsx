...
const questions = [
  {
    id: 1,
    question: "Which risk management strategy involves deploying technical controls (firewalls, MFA, encryption) to decrease threat impact?",
    options: [
      { text: "Risk Mitigation", isCorrect: true },
      { text: "Risk Avoidance", isCorrect: false },
      { text: "Risk Transference", isCorrect: false }
    ],
    explanation: "Risk Mitigation deploys security controls to reduce likelihood or impact!"
  },
  {
    id: 2,
    question: "Which risk strategy involves purchasing cybersecurity insurance or signing a vendor SLA contract?",
    options: [
      { text: "Risk Transference", isCorrect: true },
      { text: "Risk Acceptance", isCorrect: false },
      { text: "Risk Avoidance", isCorrect: false }
    ],
    explanation: "Risk Transference shifts financial loss burden to a third party or insurer!"
  },
  {
    id: 3,
    question: "Which risk strategy involves completely shutting down an unsecure legacy system to eliminate the threat entirely?",
    options: [
      { text: "Risk Avoidance", isCorrect: true },
      { text: "Risk Mitigation", isCorrect: false },
      { text: "Risk Exception", isCorrect: false }
    ],
    explanation: "Risk Avoidance completely halts or decommissions the risky activity!"
  },
  {
    id: 4,
    question: "Which risk management strategy involves formally logging a temporary waiver for a non-compliant system?",
    options: [
      { text: "Risk Exception", isCorrect: true },
      { text: "SLA Penalty", isCorrect: false },
      { text: "Risk Avoidance", isCorrect: false }
    ],
    explanation: "A Risk Exception formally records a temporary policy waiver with executive sign-off!"
  },
  {
    id: 5,
    question: "How does a Service Level Agreement (SLA) transfer operational uptime risk to a cloud provider?",
    options: [
      { text: "By mandating financial refund credits if the vendor suffers an unscheduled outage", isCorrect: true },
      { text: "By deleting all user passwords", isCorrect: false },
      { text: "By sending paper letters to the government", isCorrect: false }
    ],
    explanation: "SLA contracts enforce financial refund penalties when vendors fail to meet guaranteed uptime levels!"
  }
];

export default function RiskStrategyQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-purple-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-purple-100">Risk Strategies Challenge</span>
          <h3 class="text-2xl font-extrabold">Master Acceptance, Avoidance, Transference, & Mitigation! 🧭🛡️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-purple-50 border border-purple-200 rounded-2xl max-w-md mx-auto text-purple-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Risk Management Strategies & SLAs!'
              : '👍 Great job! Review the Strategy Matrix and SLA Transference toys and try again for 100%!'}
          </div>
