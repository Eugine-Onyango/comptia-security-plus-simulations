...
const questions = [
  {
    id: 1,
    question: "Which video surveillance system broadcasts private security camera feeds strictly to closed internal monitors?",
    options: [
      { text: "CCTV (Closed-Circuit Television)", isCorrect: true },
      { text: "Public Cable TV", isCorrect: false },
      { text: "USB Flash Drive", isCorrect: false }
    ],
    explanation: "CCTV (Closed-Circuit Television) is a private, closed video surveillance system!"
  },
  {
    id: 2,
    question: "Which light spectrum is utilized by night-vision cameras to capture clear video in total darkness?",
    options: [
      { text: "IR (Infrared)", isCorrect: true },
      { text: "UV (Ultraviolet)", isCorrect: false },
      { text: "X-Ray", isCorrect: false }
    ],
    explanation: "IR (Infrared) LEDs illuminate invisible thermal light for night-vision cameras!"
  },
  {
    id: 3,
    question: "What happens to a standard CCTV camera without IR night-vision capabilities when room lights turn off?",
    options: [
      { text: "It becomes completely blind (black screen)", isCorrect: true },
      { text: "It zooms in automatically", isCorrect: false },
      { text: "It records thermal colors", isCorrect: false }
    ],
    explanation: "Standard optical cameras require visible light and become blind in 0 lux darkness!"
  },
  {
    id: 4,
    question: "Why is CCTV referred to as 'Closed-Circuit'?",
    options: [
      { text: "Because the signal is sent to a limited set of private monitors", isCorrect: true },
      { text: "Because the camera is shut off", isCorrect: false },
      { text: "Because it requires no power", isCorrect: false }
    ],
    explanation: "Closed-Circuit means the video signal is not publicly broadcasted!"
  },
  {
    id: 5,
    question: "Which physical security component allows guards to monitor perimeter gates 24 hours a day, day and night?",
    options: [
      { text: "IR-Equipped CCTV Cameras", isCorrect: true },
      { text: "DVD Player", isCorrect: false },
      { text: "RAM Module", isCorrect: false }
    ],
    explanation: "IR-equipped CCTV cameras provide continuous 24/7 video surveillance!"
  }
];

export default function PhysicalSecQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-6 text-white shadow-lg shadow-indigo-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-indigo-100">Physical Security Challenge</span>
          <h3 class="text-2xl font-extrabold">Master CCTV & IR Night Vision! 📹🌙</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-indigo-50 border border-indigo-200 rounded-2xl max-w-md mx-auto text-indigo-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered CCTV & IR Night Vision!'
              : '👍 Great job! Review the CCTV toys and try again for 100%!'}
          </div>
