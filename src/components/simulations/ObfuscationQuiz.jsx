...
const questions = [
  {
    id: 1,
    question: "Which sensitive personal identifier acronym is subject to masking such as `***-**-1112`?",
    options: [
      { text: "SSN (Social Security Number)", isCorrect: true },
      { text: "RAM", isCorrect: false },
      { text: "CPU", isCorrect: false }
    ],
    explanation: "SSN (Social Security Number) is a primary identifier subject to masking!"
  },
  {
    id: 2,
    question: "What does PII stand for in privacy regulations and data masking?",
    options: [
      { text: "Personally Identifiable Information", isCorrect: true },
      { text: "Public Internet Protocol", isCorrect: false },
      { text: "Private Key Infrastructure", isCorrect: false }
    ],
    explanation: "PII stands for Personally Identifiable Information!"
  },
  {
    id: 3,
    question: "Which transport protocol is utilized in network steganography to embed secret data in header fields?",
    options: [
      { text: "TCP (Transmission Control Protocol)", isCorrect: true },
      { text: "EFS", isCorrect: false },
      { text: "ROM", isCorrect: false }
    ],
    explanation: "TCP (Transmission Control Protocol) headers are used for network steganography!"
  },
  {
    id: 4,
    question: "Why do companies mask SSN and PII data on customer support agent screens?",
    options: [
      { text: "To allow identity verification without exposing raw sensitive credentials", isCorrect: true },
      { text: "To speed up computer screens", isCorrect: false },
      { text: "To delete the customer database", isCorrect: false }
    ],
    explanation: "Data masking enables verification while preventing identity theft!"
  },
  {
    id: 5,
    question: "What is network steganography?",
    options: [
      { text: "Hiding secret messages inside normal network protocol traffic (like TCP headers)", isCorrect: true },
      { text: "Formatting a hard drive", isCorrect: false },
      { text: "Building a hardware firewall", isCorrect: false }
    ],
    explanation: "Network steganography conceals hidden messages inside legitimate protocol traffic!"
  }
];

export default function ObfuscationQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-amber-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-amber-100">Obfuscation Challenge</span>
          <h3 class="text-2xl font-extrabold">Master PII, SSN, & TCP Steganography! 🎨🕵️‍♂️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered PII, SSN, & TCP Steganography!'
              : '👍 Great job! Review the Obfuscation toys and try again for 100%!'}
          </div>
