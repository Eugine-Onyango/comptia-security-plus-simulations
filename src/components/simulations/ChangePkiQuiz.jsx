...
const questions = [
  {
    id: 1,
    question: "Which executive leadership position requires awareness and visibility during high-impact technical changes?",
    options: [
      { text: "CEO (Chief Executive Officer)", isCorrect: true },
      { text: "CCTV", isCorrect: false },
      { text: "USB", isCorrect: false }
    ],
    explanation: "Critical changes require CEO (Chief Executive Officer) visibility and leadership awareness!"
  },
  {
    id: 2,
    question: "Which department oversees risk assessment, sandbox testing, and rollback plans for change management?",
    options: [
      { text: "IT (Information Technology)", isCorrect: true },
      { text: "IR", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "The IT (Information Technology) department manages and evaluates technical changes!"
  },
  {
    id: 3,
    question: "What does PKI stand for in cybersecurity certificate ecosystems?",
    options: [
      { text: "Public Key Infrastructure", isCorrect: true },
      { text: "Private Known Internet", isCorrect: false },
      { text: "Protected Kernel Interface", isCorrect: false }
    ],
    explanation: "PKI stands for Public Key Infrastructure!"
  },
  {
    id: 4,
    question: "Why is asymmetric PKI encryption used during the initial Key Exchange phase?",
    options: [
      { text: "To securely exchange a fast symmetric session key across an untrusted network", isCorrect: true },
      { text: "To replace all hard drives", isCorrect: false },
      { text: "To increase Wi-Fi range", isCorrect: false }
    ],
    explanation: "Asymmetric PKI keys safely deliver the symmetric session key without exposing it!"
  },
  {
    id: 5,
    question: "What type of key is used for fast bulk data encryption AFTER the PKI key exchange completes?",
    options: [
      { text: "Symmetric Session Key", isCorrect: true },
      { text: "Paper Key", isCorrect: false },
      { text: "DNS Key", isCorrect: false }
    ],
    explanation: "Symmetric keys perform high-speed bulk data encryption after the PKI key exchange!"
  }
];

export default function ChangePkiQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      {/* Top Banner */}
      <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-blue-100">Change & PKI Challenge</span>
          <h3 class="text-2xl font-extrabold">Master CEO, IT, & PKI Key Exchange! 📋🗝️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered CEO, IT, & PKI Key Exchange!'
              : '👍 Great job! Review the Change Management & PKI toys and try again for 100%!'}
          </div>
