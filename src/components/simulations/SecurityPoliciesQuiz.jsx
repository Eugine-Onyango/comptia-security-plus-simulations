...
const questions = [
  {
    id: 1,
    question: "Which U.S. federal organization publishes foundational cybersecurity guidelines like NIST SP 800-53?",
    options: [
      { text: "NIST (National Institute of Standards and Technology)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "NIST creates government cybersecurity standards and SP 800-53 security controls!"
  },
  {
    id: 2,
    question: "Which contractual agreement guarantees cloud uptime metrics (e.g. 99.99%) and specifies financial penalties for downtime?",
    options: [
      { text: "SLA (Service Level Agreement)", isCorrect: true },
      { text: "AUP (Acceptable Use Policy)", isCorrect: false },
      { text: "NDA (Non-Disclosure Agreement)", isCorrect: false }
    ],
    explanation: "An SLA guarantees service performance and outlines compensation for outages!"
  },
  {
    id: 3,
    question: "Which policy dictates authorized vs prohibited activities for employees using company laptops and Wi-Fi?",
    options: [
      { text: "AUP (Acceptable Use Policy)", isCorrect: true },
      { text: "SLA", isCorrect: false },
      { text: "GPS", isCorrect: false }
    ],
    explanation: "An AUP defines rules for how corporate devices and network resources may be used!"
  },
  {
    id: 4,
    question: "Which formal document outlines mutual cooperation goals between two organizations before entering a contract?",
    options: [
      { text: "MOU / MOA (Memorandum of Understanding / Agreement)", isCorrect: true },
      { text: "SSD", isCorrect: false },
      { text: "ACL", isCorrect: false }
    ],
    explanation: "MOUs and MOAs formalize partnerships and mutual expectations between organizations!"
  },
  {
    id: 5,
    question: "Which legal contract prevents employees or vendors from sharing proprietary trade secrets and confidential information?",
    options: [
      { text: "NDA (Non-Disclosure Agreement)", isCorrect: true },
      { text: "SLA", isCorrect: false },
      { text: "NAT", isCorrect: false }
    ],
    explanation: "An NDA legally binds individuals to maintain absolute confidentiality of sensitive company data!"
  }
];

export default function SecurityPoliciesQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-purple-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-purple-100">Security Policies Challenge</span>
          <h3 class="text-2xl font-extrabold">Master NIST, SLA, AUP, MOU/MOA, & NDA! 📜🤝</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-purple-50 border border-purple-200 rounded-2xl max-w-md mx-auto text-purple-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Security Policies & Agreements!'
              : '👍 Great job! Review the SLA/AUP and MOU/NDA toys and try again for 100%!'}
          </div>
