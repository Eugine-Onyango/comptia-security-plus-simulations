...
const questions = [
  {
    id: 1,
    question: "What does VLAN stand for in network infrastructure architecture?",
    options: [
      { text: "Virtual Local Area Network", isCorrect: true },
      { text: "Very Large Application Node", isCorrect: false },
      { text: "Visual Link Alignment Network", isCorrect: false }
    ],
    explanation: "VLAN stands for Virtual Local Area Network!"
  },
  {
    id: 2,
    question: "Which architecture separates network devices into Data, Control, and Management planes?",
    options: [
      { text: "SDN (Software Defined Networking)", isCorrect: true },
      { text: "SSD", isCorrect: false },
      { text: "ROM", isCorrect: false }
    ],
    explanation: "SDN (Software Defined Networking) splits network management into 3 distinct logical planes!"
  },
  {
    id: 3,
    question: "Which protocol remaps internal private IP addresses to a single public IP address across a router?",
    options: [
      { text: "NAT (Network Address Translation)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "GPS", isCorrect: false }
    ],
    explanation: "NAT (Network Address Translation) maps internal private IPs to public internet addresses!"
  },
  {
    id: 4,
    question: "Which encrypted management protocol is used by network admins for secure command-line control?",
    options: [
      { text: "SSH (Secure Shell)", isCorrect: true },
      { text: "FTP", isCorrect: false },
      { text: "HTTP", isCorrect: false }
    ],
    explanation: "SSH (Secure Shell) provides encrypted remote terminal management!"
  },
  {
    id: 5,
    question: "What is used in the SDN management plane to allow automated scripts to configure network devices programmatically?",
    options: [
      { text: "API (Application Programming Interface)", isCorrect: true },
      { text: "RAM", isCorrect: false },
      { text: "UPS", isCorrect: false }
    ],
    explanation: "APIs allow automated management and programmatic control of SDN devices!"
  }
];

export default function NetworkConceptsQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      {/* Top Banner */}
      <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-6 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-blue-100">Network Concepts Challenge</span>
          <h3 class="text-2xl font-extrabold">Master VLAN, SDN, NAT, SSH, & API! 🏢✈️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered VLAN, SDN, NAT, SSH, & API!'
              : '👍 Great job! Review the Network Concepts toys and try again for 100%!'}
          </div>
