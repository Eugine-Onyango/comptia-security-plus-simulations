...
const questions = [
  {
    id: 1,
    question: "Which system design principle ensures maximum uptime and seamless automatic failover via redundant active nodes?",
    options: [
      { text: "HA (High Availability)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "HA (High Availability) provides fault tolerance and automatic failover!"
  },
  {
    id: 2,
    question: "Which leading cloud platform provides Multi-AZ (Availability Zone) infrastructure for building resilient systems?",
    options: [
      { text: "AWS (Amazon Web Services)", isCorrect: true },
      { text: "CCTV", isCorrect: false },
      { text: "USB", isCorrect: false }
    ],
    explanation: "AWS (Amazon Web Services) offers global Multi-AZ resiliency infrastructure!"
  },
  {
    id: 3,
    question: "Which disaster planning strategy ensures essential business and government operations continue during catastrophes?",
    options: [
      { text: "COOP (Continuity of Operations Planning)", isCorrect: true },
      { text: "URL Filtering", isCorrect: false },
      { text: "DNS Spoofing", isCorrect: false }
    ],
    explanation: "COOP (Continuity of Operations Planning) ensures business functions survive disasters!"
  },
  {
    id: 4,
    question: "What core software layer (e.g. Linux/Windows) is mirrored across HA nodes and booted in backup cloud environments?",
    options: [
      { text: "OS (Operating System)", isCorrect: true },
      { text: "HDMI Cable", isCorrect: false },
      { text: "GPS Antenna", isCorrect: false }
    ],
    explanation: "OS (Operating System) images are mirrored to enable rapid disaster recovery!"
  },
  {
    id: 5,
    question: "If a lightning strike destroys Primary Data Center A, how does an AWS HA cluster prevent user downtime?",
    options: [
      { text: "By automatically rerouting 100% of traffic to Secondary Data Center B", isCorrect: true },
      { text: "By turning off the internet for everyone", isCorrect: false },
      { text: "By deleting all user passwords", isCorrect: false }
    ],
    explanation: "HA load balancers instantly reroute web traffic to healthy standby nodes!"
  }
];

export default function ResiliencyQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-amber-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-amber-100">Resiliency Challenge</span>
          <h3 class="text-2xl font-extrabold">Master HA, OS, AWS, & COOP! ⚡☁️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered HA, OS, AWS, & COOP!'
              : '👍 Great job! Review the AWS HA and COOP toys and try again for 100%!'}
          </div>
