...
const questions = [
  {
    id: 1,
    question: "Which process evaluates the potential financial and operational impact of an interruption to critical business functions?",
    options: [
      { text: "BIA (Business Impact Analysis)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "BIA (Business Impact Analysis) evaluates outage impacts and recovery priorities!"
  },
  {
    id: 2,
    question: "Which metric defines the maximum acceptable amount of data loss measured in time (e.g. 2 hours of transactions)?",
    options: [
      { text: "RPO (Recovery Point Objective)", isCorrect: true },
      { text: "RTO", isCorrect: false },
      { text: "NDA", isCorrect: false }
    ],
    explanation: "RPO (Recovery Point Objective) dictates backup frequency and data loss limits!"
  },
  {
    id: 3,
    question: "Which metric defines the maximum acceptable amount of time that a service can be offline before severe financial damage occurs?",
    options: [
      { text: "RTO (Recovery Time Objective)", isCorrect: true },
      { text: "RPO", isCorrect: false },
      { text: "GPS", isCorrect: false }
    ],
    explanation: "RTO (Recovery Time Objective) defines the downtime limit to restore services!"
  },
  {
    id: 4,
    question: "Which hardware reliability metric measures the average expected operating time before a component fails?",
    options: [
      { text: "MTBF (Mean Time Between Failures)", isCorrect: true },
      { text: "MTTR", isCorrect: false },
      { text: "AUP", isCorrect: false }
    ],
    explanation: "MTBF (Mean Time Between Failures) measures component lifespan and reliability!"
  },
  {
    id: 5,
    question: "Which metric measures the average time required for technicians to repair or replace a broken server?",
    options: [
      { text: "MTTR (Mean Time to Repair)", isCorrect: true },
      { text: "MTBF", isCorrect: false },
      { text: "SLA", isCorrect: false }
    ],
    explanation: "MTTR (Mean Time to Repair) measures the average duration needed to restore a failed component!"
  }
];

export default function BiaQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-purple-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-purple-100">Business Impact Challenge</span>
          <h3 class="text-2xl font-extrabold">Master BIA, RTO, RPO, MTTR, & MTBF! ⏱️📊</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-purple-50 border border-purple-200 rounded-2xl max-w-md mx-auto text-purple-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Business Impact Analysis & Recovery Metrics!'
              : '👍 Great job! Review the RTO/RPO Timeline and MTBF/MTTR toys and try again for 100%!'}
          </div>
