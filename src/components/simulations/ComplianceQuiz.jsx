...
const questions = [
  {
    id: 1,
    question: "Which compliance standard mandates strict security controls for processing credit card payment transactions?",
    options: [
    ...
    explanation: "PCI DSS protects payment cards and credit card numbers!"
  },
  {
    id: 2,
    question: "Which law mandates internal financial accounting controls and tamper-proof auditing logs for public companies?",
    options: [
      { text: "SOX (Sarbanes-Oxley Act)", isCorrect: true },
      { text: "GLBA", isCorrect: false },
      { text: "NDA", isCorrect: false }
    ],
    explanation: "SOX mandates accounting transparency and auditing to prevent financial fraud!"
  },
  {
    id: 3,
    question: "Which regulation protects patient Protected Health Information (PHI) across hospitals and healthcare providers?",
    options: [
    ...
    explanation: "HIPAA protects patient health data and medical records!"
  },
  {
    id: 4,
    question: "Which regulation requires financial institutions and banks to protect customer non-public financial records?",
    options: [
      { text: "GLBA (Gramm-Leach-Bliley Act)", isCorrect: true },
      { text: "SOX", isCorrect: false },
      { text: "NDA", isCorrect: false }
    ],
    explanation: "GLBA mandates consumer financial privacy for banks and lending institutions!"
  },
  {
    id: 5,
    question: "Which European regulation grants citizens the 'Right to be Forgotten' and mandates strict personal data privacy?",
    options: [
      { text: "GDPR (General Data Protection Regulation)", isCorrect: true },
      { text: "PCI DSS", isCorrect: false },
      { text: "GLBA", isCorrect: false }
    ],
    explanation: "GDPR protects EU citizens' privacy rights, including data deletion and portability!"
  }
];
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-6 text-white shadow-lg shadow-indigo-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-indigo-100">Compliance Challenge</span>
          <h3 class="text-2xl font-extrabold">Master PCI DSS, SOX, HIPAA, GLBA, NDA, & GDPR! 🏛️⚖️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-indigo-50 border border-indigo-200 rounded-2xl max-w-md mx-auto text-indigo-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Global Regulatory Compliance Laws!'
              : '👍 Great job! Review the Compliance Radar and Audit Engine toys and try again for 100%!'}
          </div>
