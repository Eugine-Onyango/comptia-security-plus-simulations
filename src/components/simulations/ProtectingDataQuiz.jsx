...
const questions = [
  {
    id: 1,
    question: "Which landmark privacy regulation enforced by the European Union grants citizens the Right to Erasure (Right to be Forgotten)?",
    options: [
      { text: "GDPR (General Data Protection Regulation)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "GDPR (General Data Protection Regulation) is the EU privacy law granting data sovereignty and the Right to be Forgotten!"
  },
  {
    id: 2,
    question: "Which political and economic union created and enforces the General Data Protection Regulation (GDPR)?",
    options: [
      { text: "EU (European Union)", isCorrect: true },
      { text: "NASA", isCorrect: false },
      { text: "IEEE", isCorrect: false }
    ],
    explanation: "The EU (European Union) enforces GDPR privacy laws across all member states!"
  },
  {
    id: 3,
    question: "Which GDPR principle mandates that organizations must ONLY collect the minimum personal data strictly necessary for the service?",
    options: [
      { text: "Data Minimization", isCorrect: true },
      { text: "Excessive Data Harvesting", isCorrect: false },
      { text: "Unlimited Storage", isCorrect: false }
    ],
    explanation: "Data Minimization requires collecting only essential PII needed for the immediate service!"
  },
  {
    id: 4,
    question: "Which sensitive 9-digit personal identifier is subject to strict masking (e.g. ***-**-1112) and encryption?",
    options: [
      { text: "SSN (Social Security Number)", isCorrect: true },
      { text: "URL", isCorrect: false },
      { text: "VPN", isCorrect: false }
    ],
    explanation: "SSN stands for Social Security Number, a highly sensitive PII identifier!"
  },
  {
    id: 5,
    question: "Under GDPR, why are IP addresses and GPS location logs protected as PII?",
    options: [
      { text: "Because they can be combined to uniquely identify an individual person", isCorrect: true },
      { text: "Because they speed up internet connection speeds", isCorrect: false },
      { text: "Because they are stored on CD-ROMs", isCorrect: false }
    ],
    explanation: "IP addresses and GPS location logs are classified as PII because they track and identify specific individuals!"
  }
];

export default function ProtectingDataQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-blue-100">Protecting Data & GDPR Challenge</span>
          <h3 class="text-2xl font-extrabold">Master GDPR, EU, GPS, IP, PII, & SSN! 🇪🇺🛡️</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Protecting Data & EU GDPR!'
              : '👍 Great job! Review the GDPR Shredder and Data Minimization toys and try again for 100%!'}
          </div>
