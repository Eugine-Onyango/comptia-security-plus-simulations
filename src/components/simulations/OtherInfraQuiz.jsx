...
const questions = [
  {
    id: 1,
    question: "What does IoT stand for in smart connected devices and factory sensors?",
    options: [
      { text: "Internet of Things", isCorrect: true },
      { text: "Input Operating Terminal", isCorrect: false },
      { text: "Internal Offline Transfer", isCorrect: false }
    ],
    explanation: "IoT stands for Internet of Things!"
  },
  {
    id: 2,
    question: "Which large-scale industrial architecture monitors power plants, refineries, and water facilities across multiple sites?",
    options: [
      { text: "SCADA (Supervisory Control and Data Acquisition)", isCorrect: true },
      { text: "CCTV", isCorrect: false },
      { text: "USB", isCorrect: false }
    ],
    explanation: "SCADA (Supervisory Control and Data Acquisition) monitors large-scale industrial infrastructure!"
  },
  {
    id: 3,
    question: "What does ICS stand for in manufacturing and energy command centers?",
    options: [
      { text: "Industrial Control Systems", isCorrect: true },
      { text: "Internal Cipher Standard", isCorrect: false },
      { text: "Integrated Chip Set", isCorrect: false }
    ],
    explanation: "ICS stands for Industrial Control Systems!"
  },
  {
    id: 4,
    question: "Why do industrial machines and automobiles use RTOS (Real-Time Operating System)?",
    options: [
      { text: "An RTOS provides a deterministic processing schedule with zero time to wait for time-critical tasks", isCorrect: true },
      { text: "Because it plays video games faster", isCorrect: false },
      { text: "To replace all hard drives", isCorrect: false }
    ],
    explanation: "RTOS guarantees deterministic processing deadlines for safety-critical hardware!"
  },
  {
    id: 5,
    question: "What is the primary goal of HA (High Availability) cluster designs?",
    options: [
      { text: "To ensure continuous operational uptime with zero downtime during hardware crashes", isCorrect: true },
      { text: "To slow down network traffic", isCorrect: false },
      { text: "To delete backup files automatically", isCorrect: false }
    ],
    explanation: "HA (High Availability) provides redundant failover to eliminate downtime!"
  }
];

export default function OtherInfraQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      {/* Top Banner */}
      <div class="bg-gradient-to-r from-amber-500 to-emerald-600 rounded-3xl p-6 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-amber-100">Industrial & HA Challenge</span>
          <h3 class="text-2xl font-extrabold">Master IoT, SCADA, ICS, RTOS, & HA! 🏭⚡</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered IoT, SCADA, ICS, RTOS, & HA!'
              : '👍 Great job! Review the SCADA & HA toys and try again for 100%!'}
          </div>
