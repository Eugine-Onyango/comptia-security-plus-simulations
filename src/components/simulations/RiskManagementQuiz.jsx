...
const questions = [
  {
    id: 1,
    question: "Which NIST special publication outlines the 7-step Risk Management Framework (RMF)?",
    options: [
      { text: "NIST SP 800-37", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "NIST SP 800-37 details the Risk Management Framework (RMF) 7-step lifecycle!"
  },
  {
    id: 2,
    question: "In which step of the RMF lifecycle does an authorizing official grant formal Authority to Operate (ATO)?",
    options: [
      { text: "Step 6: Authorize", isCorrect: true },
      { text: "Step 1: Prepare", isCorrect: false },
      { text: "Step 2: Categorize", isCorrect: false }
    ],
    explanation: "The Authorize step produces the formal ATO decision allowing a system to go live!"
  },
  {
    id: 3,
    question: "What is the primary purpose of a Key Risk Indicator (KRI)?",
    options: [
      { text: "To provide early warning signals of increasing risk exposure before a breach occurs", isCorrect: true },
      { text: "To format hard drives faster", isCorrect: false },
      { text: "To replace human employees with robots", isCorrect: false }
    ],
    explanation: "KRIs act like dashboard warning gauges to signal elevated risk exposure!"
  },
  {
    id: 4,
    question: "Why is Step 7 (Monitor) essential in the Risk Management Framework (RMF)?",
    options: [
      { text: "To continuously evaluate controls and emerging threat intelligence over time", isCorrect: true },
      { text: "To delete all system logs", isCorrect: false },
      { text: "To disable employee internet access", isCorrect: false }
    ],
    explanation: "Monitoring ensures security controls remain effective as threats evolve!"
  },
  {
    id: 5,
    question: "If an enterprise notices unpatched vulnerabilities spiking from 2 to 40, what early warning gauge has been triggered?",
    options: [
      { text: "KRI (Key Risk Indicator) Threshold Exceeded", isCorrect: true },
      { text: "SLA Outage Penalty", isCorrect: false },
      { text: "AUP Torrent Ban", isCorrect: false }
    ],
    explanation: "KRIs monitor quantifiable operational metrics to warn of rising risk levels!"
  }
];

export default function RiskManagementQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-6 text-white shadow-lg shadow-indigo-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-indigo-100">Risk Management Challenge</span>
          <h3 class="text-2xl font-extrabold">Master RMF & KRI! 🔄📊</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-indigo-50 border border-indigo-200 rounded-2xl max-w-md mx-auto text-indigo-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Risk Management Frameworks & KRIs!'
              : '👍 Great job! Review the RMF Lifecycle and KRI Radar toys and try again for 100%!'}
          </div>
