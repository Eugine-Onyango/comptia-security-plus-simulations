...
const questions = [
  {
    id: 1,
    question: "What does RADIUS stand for in network authentication architecture?",
    options: [
      { text: "Remote Authentication Dial-In User Service", isCorrect: true },
      { text: "Random Automated Device Inspection System", isCorrect: false },
      { text: "Real-time Access Directory User Suite", isCorrect: false }
    ],
    explanation: "RADIUS stands for Remote Authentication Dial-In User Service!"
  },
  {
    id: 2,
    question: "What does LDAP stand for in active directory user lookups?",
    options: [
      { text: "Lightweight Directory Access Protocol", isCorrect: true },
      { text: "Local Device Application Processor", isCorrect: false },
      { text: "Log Data Aggregation Platform", isCorrect: false }
    ],
    explanation: "LDAP stands for Lightweight Directory Access Protocol!"
  },
  {
    id: 3,
    question: "What does TACACS+ stand for in network administrative control?",
    options: [
      { text: "Terminal Access Controller Access-Control System Plus", isCorrect: true },
      { text: "Total Automated Access Control Security", isCorrect: false },
      { text: "Transfer Access Code Authentication System", isCorrect: false }
    ],
    explanation: "TACACS+ stands for Terminal Access Controller Access-Control System Plus!"
  },
  {
    id: 4,
    question: "Which protocol encrypts the 100% ENTIRE packet body and uses TCP port 49 for router/switch administration?",
    options: [
      { text: "TACACS+", isCorrect: true },
      { text: "RADIUS", isCorrect: false },
      { text: "HTTP", isCorrect: false }
    ],
    explanation: "TACACS+ encrypts the entire packet body over TCP port 49!"
  },
  {
    id: 5,
    question: "Which protocol encrypts passwords ONLY over UDP ports 1812/1813 and is widely used for 802.1X Wi-Fi & VPN authentication?",
    options: [
      { text: "RADIUS", isCorrect: true },
      { text: "TACACS+", isCorrect: false },
      { text: "SSH", isCorrect: false }
    ],
    explanation: "RADIUS uses UDP ports 1812/1813 and encrypts passwords only!"
  }
];

export default function AaaServersQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-amber-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-amber-100">AAA & Directory Challenge</span>
          <h3 class="text-2xl font-extrabold">Master RADIUS, LDAP, & TACACS+! 🏢🔑</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered RADIUS, LDAP, & TACACS+!'
              : '👍 Great job! Review the AAA toys and try again for 100%!'}
          </div>
