...
const questions = [
  {
    id: 1,
    question: "Which European Union privacy regulation grants citizens the Right to be Forgotten and mandates strict data protection?",
    options: [
      { text: "GDPR (General Data Protection Regulation)", isCorrect: true },
      { text: "SOX", isCorrect: false },
      { text: "PCI DSS", isCorrect: false }
    ],
    explanation: "GDPR protects EU citizens' data privacy rights!"
  },
  {
    id: 2,
    question: "Under GDPR regulations, is an Internet Protocol (IP) address classified as Personally Identifiable Information (PII)?",
    options: [
      { text: "Yes, IP addresses are explicitly classified as PII under GDPR", isCorrect: true },
      { text: "No, IP addresses are public numbers", isCorrect: false },
      { text: "Only if the IP address starts with 192", isCorrect: false }
    ],
    explanation: "GDPR explicitly classifies IP addresses and online identifiers as PII!"
  },
  {
    id: 3,
    question: "Which executive role is responsible for overseeing privacy compliance and acting as liaison with regulatory authorities?",
    options: [
      { text: "DPO (Data Protection Officer)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "RAM", isCorrect: false }
    ],
    explanation: "The Data Protection Officer (DPO) leads enterprise privacy compliance!"
  },
  {
    id: 4,
    question: "Which assessment is mandatory under GDPR Article 35 before starting high-risk data processing operations?",
    options: [
      { text: "DPIA (Data Protection Impact Assessment)", isCorrect: true },
      { text: "SLA Outage Penalty", isCorrect: false },
      { text: "AUP", isCorrect: false }
    ],
    explanation: "A DPIA is a mandatory GDPR assessment for high-risk data processing!"
  },
  {
    id: 5,
    question: "What is the primary difference between PII and PHI?",
    options: [
      { text: "PII is general identification data (Name, SSN, IP), while PHI is medical/health data (Prescriptions, Diagnoses)", isCorrect: true },
      { text: "PII is for hardware, PHI is for software", isCorrect: false },
      { text: "There is no difference", isCorrect: false }
    ],
    explanation: "PII covers general personal identity, whereas PHI specifically covers Protected Health Information!"
  }
];
  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-3xl p-6 text-white shadow-lg shadow-purple-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-purple-100">Privacy Challenge</span>
          <h3 class="text-2xl font-extrabold">Master GDPR, EU, IP, DPO, PIA, DPIA, PHI, & PII! 🛡️🇪🇺</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-purple-50 border border-purple-200 rounded-2xl max-w-md mx-auto text-purple-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Data Privacy & Protection Frameworks!'
              : '👍 Great job! Review the DPIA Scanner and DPO Dispatcher toys and try again for 100%!'}
          </div>
