...
const questions = [
  {
    id: 1,
    question: "What process compares a company's current security posture against a framework standard to find missing security controls?",
    options: [
      { text: "Gap Analysis", isCorrect: true },
      { text: "CPU Overclocking", isCorrect: false },
      { text: "Password Hashing", isCorrect: false }
    ],
    explanation: "Gap Analysis compares your current state against target standards to identify missing security controls!"
  },
  {
    id: 2,
    question: "Which US organization publishes cybersecurity frameworks such as NIST SP 800-171?",
    options: [
      { text: "NIST (National Institute of Standards and Technology)", isCorrect: true },
      { text: "USB", isCorrect: false },
      { text: "SSD", isCorrect: false }
    ],
    explanation: "NIST (National Institute of Standards and Technology) develops US security frameworks!"
  },
  {
    id: 3,
    question: "Which global organization produces international standards like ISO/IEC 27001?",
    options: [
      { text: "ISO (International Organization for Standardization)", isCorrect: true },
      { text: "HTTP", isCorrect: false },
      { text: "EFS", isCorrect: false }
    ],
    explanation: "ISO (International Organization for Standardization) develops international standards!"
  },
  {
    id: 4,
    question: "Which electrotechnical standard body co-developed the ISO/IEC 27001 security standard alongside ISO?",
    options: [
      { text: "IEC (International Electrotechnical Commission)", isCorrect: true },
      { text: "CPU", isCorrect: false },
      { text: "NAT", isCorrect: false }
    ],
    explanation: "IEC (International Electrotechnical Commission) co-authors ISO/IEC IT standards!"
  },
  {
    id: 5,
    question: "If a company passes 2 out of 4 required security controls in a gap audit, what is their identified security gap?",
    options: [
      { text: "50% Security Gap (2 Controls Missing)", isCorrect: true },
      { text: "0% Gap", isCorrect: false },
      { text: "100% Gap", isCorrect: false }
    ],
    explanation: "2 out of 4 controls missing equals a 50% security gap!"
  }
];
...
export default function GapQuiz() {
  ...
  return (
    <div class="space-y-6">
      ...
      {/* Top Banner */}
      <div class="bg-gradient-to-r from-amber-500 to-blue-600 rounded-3xl p-6 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between">
        <div>
          <span class="text-xs font-extrabold uppercase tracking-widest text-amber-100">Gap Analysis Challenge</span>
          <h3 class="text-2xl font-extrabold">Master NIST, ISO, & IEC! 📏📜</h3>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered Gap Analysis, NIST, ISO, & IEC!'
              : '👍 Great job! Review the Gap Audit toys and try again for 100%!'}
          </div>
