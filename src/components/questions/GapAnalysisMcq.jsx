...
const rawQuestions = [
  {
    id: 1,
    question: "A company conducts an extensive multi-week security evaluation to determine where their current cybersecurity posture stands compared to where they want to be. What process calculates the delta between the current state and the target security baseline?",
    options: [
      { 
        text: "Gap Analysis", 
        isCorrect: true, 
      ...
      { 
        text: "SQL Injection", 
        isCorrect: false, 
        whyWrong: "SQL Injection is a web database attack technique, not an evaluation process." 
      },
      { 
        text: "Typosquatting", 
        isCorrect: false, 
    ...
    laymanExplanation: "A Gap Analysis measures the 'gap' between where your security is today and where you want it to be tomorrow! It identifies missing controls and deficiencies so you know what needs fixing."
  },
  {
    id: 2,
    question: "A defense subcontractor evaluates its IT infrastructure to ensure compliance with NIST Special Publication 800-171 Rev 2 for protecting Controlled Unclassified Information (CUI). What role does NIST SP 800-171 serve in a gap analysis?",
    options: [
      { 
        text: "The Target Security Baseline / End Goal Framework", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Telnet transmits unencrypted cleartext data over port 23, providing no security framework." 
      },
      { 
    ...
    laymanExplanation: "Before measuring a gap, you need a target baseline! Standards like NIST SP 800-171 or ISO 27001 act as the official target blueprint you measure your organization against."
  },
  {
    id: 3,
    question: "During a gap analysis, security consultants interview employees to check their policy awareness, evaluate formal staff training histories, and review current IT operating procedures. What phase of the gap analysis is being performed?",
    options: [
      { 
        text: "Evaluating People and Processes", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Security isn't just technology — it's PEOPLE and PROCESSES too! Evaluating staff training, policy knowledge, and day-to-day procedures ensures your team is prepared."
  },
  {
    id: 4,
    question: "A Chief Information Security Officer (CISO) creates a color-coded matrix displaying Access Control, Audit Accountability, and Incident Response readiness across 7 branch offices (using Red for non-compliant and Green for compliant). What tool is used to visualize compliance gaps across locations?",
    options: [
      { 
        text: "Security Requirements Compliance Heatmap / Matrix", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "A Compliance Heatmap is a color-coded chart! Red boxes show dangerous security gaps, yellow shows partial progress, and green shows fully compliant areas across offices."
  },
  {
    id: 5,
    question: "At the conclusion of an enterprise gap assessment, auditors publish a formal document summarizing current state deficiencies, recommended remediation steps, estimated budgets, and a change control timeline to reach the target baseline. What document is presented to executive management?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network speed metric, not an executive assessment report." 
      },
      { 
    ...
    laymanExplanation: "The Gap Analysis Report is the final roadmap! It outlines exactly where your security is failing today, how much money and time it will take to fix it, and actionable steps to reach full compliance."
  },
  {
    id: 6,
    question: "An organization completes a gap analysis and identifies 15 unfulfilled security requirements. What essential management process controls the time, budget, and system modifications required to safely transition from the current state to the goal state?",
    options: [
      { 
    ...
    laymanExplanation: "Fixing security gaps requires Change Control! You can't just change server settings randomly — change control ensures modifications are tested, approved, budgeted, and executed without breaking live systems."
  }
];
...
export default function GapAnalysisMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            1.2 - Gap Analysis Practice 📊
          </h1>
          <p class="text-amber-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Baseline Frameworks (NIST SP 800-171, ISO 27001), People & Processes Evaluation, Compliance Heatmaps, and Gap Analysis Reports!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 1.2 Gap Analysis for CompTIA Security+!'
