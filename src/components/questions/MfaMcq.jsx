...
const rawQuestions = [
  {
    id: 1,
    question: "An organization requires employees logging into sensitive cloud portals to enter a memorized password and tap a physical USB security key (YubiKey) plugged into their workstation. What authentication model is enforced?",
    options: [
      { 
        text: "MFA (Multifactor Authentication: Something You Know + Something You Have)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "True MFA combines TWO different categories of proof! A password is 'Something You Know' and a physical USB key is 'Something You Have'."
  },
  {
    id: 2,
    question: "A bank customer logs into their account by typing a password and then answering a secret security question (mother's maiden name). Why does this setup fail to meet true Multifactor Authentication (MFA) standards?",
    options: [
      { 
        text: "Both factors belong to the same category ('Something You Know')", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Two passwords don't equal MFA! Since both a password and a secret question are things stored in your brain ('Something You Know'), it is single-factor multi-step, not true MFA."
  },
  {
    id: 3,
    question: "A high-security facility uses fingerprint scanners and iris recognition at server room doors. The scanner converts physical biological traits into mathematical representation hashes. What authentication factor category is used?",
    options: [
      { 
    ...
    laymanExplanation: "'Something You Are' covers unique physical biometrics! Fingerprints, iris scans, and facial recognition verify your physical body."
  },
  {
    id: 4,
    question: "An enterprise mobile application only grants access to corporate email if the employee enters a valid credential AND the smartphone's location services report GPS coordinates inside the corporate headquarters city limits. What factor is evaluated?",
    options: [
      { 
    ...
    laymanExplanation: "'Somewhere You Are' checks physical location! Systems check GPS, IP address geolocation, or local Wi-Fi networks to confirm you are in an approved location."
  },
  {
    id: 5,
    question: "A system administrator carries a hardware key fob that displays a fresh 6-digit pseudo-random passcode every 30 seconds. To log into root servers, the admin enters their password plus the current code on the screen. What factor category is the hardware key fob?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not Something You Have." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not Something You Have." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not Something You Have." 
      }
    ],
    laymanExplanation: "'Something You Have' is a physical object in your hand! Hardware token fobs, smart cards, and smartphones generating codes prove physical possession."
  },
  {
    id: 6,
    question: "A cybersecurity team discusses the risks of biometric authentication. Unlike passwords, if an employee's biometric fingerprint template is leaked in a data breach, what major limitation applies to 'Something You Are' factors?",
    options: [
      { 
        text: "Biometrics are permanent physical traits that cannot be changed or reset like a password", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "You can't change your fingerprints! If a password is stolen, you pick a new password. If your fingerprint pattern is stolen, you cannot get new fingers!"
  }
];
...
export default function MfaMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.6 - Multifactor Authentication Practice 📲
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Something You Know, Something You Have, Something You Are, Somewhere You Are, and True MFA Category Combinations!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.6 Multifactor Authentication for CompTIA Security+!'
