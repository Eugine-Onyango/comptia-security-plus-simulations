...
const rawQuestions = [
  {
    id: 1,
    question: "A security compliance manager requires all network firewalls, vulnerability scanners, and endpoint compliance engines across Windows and Linux to evaluate configuration benchmarks using standardized NIST criteria. What framework enables this cross-tool interoperability?",
    options: [
      { 
        text: "SCAP (Security Content Automation Protocol)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "SCAP is a universal translator for security tools! Managed by NIST, SCAP allows different scanners and tools to evaluate security compliance using identical, standardized rules."
  },
  {
    id: 2,
    question: "A system administrator needs industry-consensus best-practice hardening guidelines to secure new mobile devices, cloud environments, and operating systems. Which standard resource provided by the Center for Internet Security should be used?",
    options: [
      { 
        text: "CIS Benchmarks", 
        isCorrect: true, 
    ...
    laymanExplanation: "CIS Benchmarks are step-by-step hardening recipe books! The Center for Internet Security (CIS) provides free, proven guidelines to lock down operating systems, smartphones, and cloud setups."
  },
  {
    id: 3,
    question: "An outbound email gateway intercepts and blocks an employee's message after detecting 16-digit credit card numbers and Social Security numbers in an unencrypted attachment. What security technology performed this inspection?",
    options: [
      { 
    ...
    laymanExplanation: "DLP stops confidential data from leaking! Data Loss Prevention (DLP) scans emails, uploads, and USB drives for sensitive numbers (like SSNs or credit cards) and blocks unauthorized transfers."
  },
  {
    id: 4,
    question: "A network switch experiences a sudden hardware fan failure and proactively sends an urgent, unprompted alert message to the central network monitoring station over UDP/162 without waiting for a scheduled status poll. What mechanism was triggered?",
    options: [
      { 
        text: "SNMP Trap", 
        isCorrect: true, 
    ...
    laymanExplanation: "SNMP Traps are instant emergency alarms! Instead of waiting for the monitoring station to ask 'Are you okay?', a device sends an immediate SNMP Trap (over UDP/162) the moment something breaks."
  },
  {
    id: 5,
    question: "An IT department needs to perform a fast, one-time security compliance check on visiting contractor laptops without installing permanent software agents that require continuous updates. What assessment approach should be used?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not a compliance check method." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not compliance checking." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not a compliance check method." 
      }
    ],
    laymanExplanation: "Agentless checks run without installing software! Agentless scanning inspects a computer across the network for vulnerabilities and leaves no software behind."
  },
  {
    id: 6,
    question: "A network engineer analyzes core router bandwidth saturation by reviewing traffic flow metadata—specifically source IPs, destination IPs, port numbers, and byte counts—gathered by probes. What technology collects these flow statistics?",
    options: [
      { 
        text: "NetFlow", 
        isCorrect: true, 
    ...
    laymanExplanation: "NetFlow measures network traffic conversations! NetFlow tracks who is talking to whom, on what port, and how much data they moved."
  }
];
...
export default function SecurityToolsMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.4 - Security Tools Practice 🧰
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering SCAP, CIS Benchmarks, DLP Leak Prevention, SNMP Traps (UDP/162), Agent vs Agentless Checks, and NetFlow Traffic Summaries!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.4 Security Tools for CompTIA Security+!'
