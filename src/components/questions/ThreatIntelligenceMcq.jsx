...
const rawQuestions = [
  {
    id: 1,
    question: "A security analyst researches an emerging ransomware campaign by reading publicly available CISA advisories, vendor blogs, social media threat reports, and public code repositories. What category of threat intelligence is being used?",
    options: [
      { 
    ...
    laymanExplanation: "OSINT comes from free, public sources! Open-Source Intelligence gathers cybersecurity data from government reports, public forums, and social media without needing private subscriptions."
  },
  {
    id: 2,
    question: "A company contracts a threat intelligence team to monitor encrypted overlay networks (requiring specialized software like Tor) for executive email addresses, stolen credit card batches, and corporate credentials listed on hacking forums. What intelligence source is being monitored?",
    options: [
      { 
        text: "Dark Web Intelligence", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "The Dark Web requires special tools like Tor! Dark Web intelligence monitors hidden forums where cybercriminals trade stolen passwords, credit cards, and company secrets."
  },
  {
    id: 3,
    question: "Several enterprise security teams join an industry consortium (such as the Cyber Threat Alliance) where member companies share standardized threat data. Submissions are scored and validated so all member organizations can block newly discovered malicious IP addresses in real time. What entity is this?",
    options: [
      { 
        text: "An Information-Sharing Organization (CTA / ISAC)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Security is stronger together! Information-Sharing Organizations (like CTA and ISACs) allow companies to pool threat data so when one company blocks a new attack, everyone gets protected."
  },
  {
    id: 4,
    question: "A bank purchases a paid commercial subscription to a security vendor's threat platform that provides specialized threat analytics, hacker group profiling, and correlated global attack feeds. What classification of threat intelligence is this?",
    options: [
      { 
        text: "Proprietary / Commercial Third-Party Intelligence", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Proprietary intelligence is bought from commercial vendors! Private security companies compile dedicated threat data, correlate global attacks, and sell access as a paid intelligence service."
  },
  {
    id: 5,
    question: "A SOC analyst studies a threat report detailing the specific tools, exploitation routines, and command-and-control procedures used by an Advanced Persistent Threat (APT) actor. What core threat intelligence component is being examined?",
    options: [
      { 
        text: "Threat Actor TTPs (Tactics, Techniques, and Procedures)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not threat actor behavior." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not threat intelligence TTP analysis." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not threat actor behavior analysis." 
      }
    ],
    laymanExplanation: "TTPs describe how hackers operate! Tactics, Techniques, and Procedures explain the exact tools, playbook steps, and strategies used by specific threat actor groups."
  },
  {
    id: 6,
    question: "Why do enterprise security operations centers integrate real-time threat intelligence feeds into automated firewall and SIEM rules?",
    options: [
      { 
        text: "To enable data-driven prevention decisions and automatically block new Indicators of Compromise (IoCs) without manual delay", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Automation beats fast attacks! Feeding threat intelligence directly into firewalls lets systems automatically block newly spotted bad IP addresses and malicious domains in seconds."
  }
];
...
export default function ThreatIntelligenceMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.3 - Threat Intelligence Practice 🕵️‍♂️
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering OSINT, Dark Web Monitoring, Information-Sharing Organizations (CTA/ISAC), Proprietary Feeds, TTPs, and Automated Prevention!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.3 Threat Intelligence for CompTIA Security+!'
