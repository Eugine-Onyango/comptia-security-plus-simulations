...
const rawQuestions = [
  {
    id: 1,
    question: "A network administrator needs to modify core firewall access lists to support a new cloud service. Before making any changes in production, the administrator submits a formal proposal detailing the purpose, scope, risk analysis, maintenance window, and backout plan for review by senior leadership. What group grants final authorization?",
    options: [
      { 
        text: "Change Control Board (CCB) / Change Advisory Board (CAB)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        text: "SQL Injection", 
        isCorrect: false, 
        whyWrong: "SQL Injection is a web database attack technique, not a corporate governance board." 
      },
      { 
        text: "Typosquatting", 
        isCorrect: false, 
    ...
    laymanExplanation: "The Change Advisory Board (CAB) is the official green-light committee! They review proposed IT changes, evaluate risks, and approve updates so changes don't break business operations."
  },
  {
    id: 2,
    question: "During a scheduled midnight server update, a newly applied security patch causes a core database service to crash repeatedly. The IT team immediately executes a pre-approved procedure to undo the patch and restore the server from a fresh backup. What critical change management component was executed?",
    options: [
      { 
        text: "Backout Plan (Rollback Procedure)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "A Backout Plan is your safety net! Always prepare for the worst — having a documented rollback procedure and verified backups allows you to instantly revert a broken update."
  },
  {
    id: 3,
    question: "Before deploying a major web application upgrade to live production servers, software engineers test the patch inside an isolated environment with no connection to production systems to confirm test results. What environment is used?",
    options: [
      { 
    ...
    laymanExplanation: "A Sandbox is a safe playground! It mirrors your live network, letting you test patches and code changes safely without any danger of crashing real customer systems."
  },
  {
    id: 4,
    question: "An e-commerce retailer prohibits all non-emergency IT infrastructure changes and software updates across its network throughout November and December to prevent potential downtime during peak holiday shopping. What policy is enforced?",
    options: [
      { 
        text: "Change Freeze (Code Freeze during peak business periods)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "A Change Freeze blocks all non-essential IT updates during critical business periods (like Black Friday or tax season) so systems stay 100% stable when revenue is highest."
  },
  {
    id: 5,
    question: "The Shipping & Receiving department requests an upgrade to their automated shipping label printers. The department head signs off as the process owner, while the IT department handles the actual hardware installation. What principle distinguishes these roles?",
    options: [
      { 
        text: "Process Ownership (Business Department) vs Technical Execution (IT)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not a process ownership concept." 
      },
      { 
    ...
    laymanExplanation: "Ownership vs Execution: The business department (Shipping) OWNS the process because it affects their work, while IT EXECUTES the technical installation."
  },
  {
    id: 6,
    question: "A security team evaluates a proposed hotfix. They compare the risk of potential application instability caused by the patch against the risk of leaving a high-severity zero-day vulnerability unpatched. What analysis evaluates these trade-offs?",
    options: [
      { 
        text: "Impact Analysis (evaluating risk of change vs risk of NO change)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Impact Analysis weighs the pros and cons! It evaluates the risk of making a change against the danger of doing nothing and leaving a security hole open."
  }
];
...
export default function ChangeManagementMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            1.3 - Change Management Practice 🔄
          </h1>
          <p class="text-amber-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Change Approval Process (CAB), Backout Plans, Sandbox Testing, Maintenance Windows/Freezes, Impact Analysis, and SOPs!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 1.3 Change Management for CompTIA Security+!'
