...
const rawQuestions = [
  {
    id: 1,
    question: "A security team ingests logs from domain controllers, VPN concentrators, web firewalls, and cloud storage into a centralized platform. The platform automatically links an off-hours login from a foreign IP address to a sudden 50 GB database export. What system is being utilized?",
    options: [
      { 
    ...
    laymanExplanation: "A SIEM is the central brain of security monitoring! SIEM (Security Information and Event Management) aggregates log data from across the whole company and correlates events across different devices to spot complex cyberattacks."
  },
  {
    id: 2,
    question: "A SOC analyst is flooded with hundreds of daily email notifications for routine, authorized administrator logins, causing severe alert fatigue and delayed responses to real threats. What process should the SOC perform?",
    options: [
      { 
        text: "Alert Tuning", 
        isCorrect: true, 
    ...
    laymanExplanation: "Alert Tuning eliminates false alarm noise! Alert tuning adjusts notification rules so security analysts only get alerted for genuine threats instead of drowning in harmless routine notifications."
  },
  {
    id: 3,
    question: "When an Endpoint Detection and Response (EDR) agent detects ransomware active on a finance laptop, it instantly cuts off the device's Wi-Fi and ethernet connections to isolate it while keeping local memory active. What response action was taken?",
    options: [
      { 
        text: "Host Quarantining / Containment", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Quarantining puts infected devices in digital isolation! Cutting a compromised laptop off from the network stops malware from spreading across the rest of the company."
  },
  {
    id: 4,
    question: "Industry security statistics reveal that cyber breaches take an average of 9 months to discover and contain. Why do regulatory standards require organizations to archive log data for extended periods (such as 1 year or more)?",
    options: [
      { 
        text: "To enable historical forensic investigation and threat hunting across long attacker dwell times", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Hacking investigations need long history logs! Because hackers can hide inside network networks for months before being discovered, saving old logs lets investigators trace back to when and how the breach started."
  },
  {
    id: 5,
    question: "A security dashboard triggers a high-priority alert when an application server's outbound network data transfer rate unexpectedly jumps from 10 MB/hour to 30 GB in 15 minutes. What resource monitoring metric flagged this behavior?",
    options: [
      { 
        text: "Application Data Transfer Volume Anomaly Monitoring", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not data transfer volume exfiltration monitoring." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not data transfer volume monitoring." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not data transfer monitoring." 
      }
    ],
    laymanExplanation: "Massive data spikes signal data theft! Monitoring network data transfer rates catches hackers when they try to steal giant databases out of your servers."
  },
  {
    id: 6,
    question: "Why do modern enterprise Security Operations Centers (SOCs) configure real-time SMS, email, and console alerts for high-severity authentication failures and firewall policy changes?",
    options: [
      { 
        text: "To ensure immediate 24/7/365 response to security incidents before attacker damage escalates", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Hackers attack around the clock! 24/7/365 real-time alerting ensures security teams get notified instantly so they can stop attacks before permanent damage occurs."
  }
];
...
export default function SecurityMonitoringMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white font-extrabold text-xs backdrop-blur-md mb-2">
            <span>CompTIA Security+ SY0-701 • Section 4.4</span>
          </div>
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.4 - Security Monitoring Practice 🖥️
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering SIEM Log Aggregation, Alert Tuning, Host Quarantining, Long-term Log Archiving, Resource Anomaly Detection, and 24/7/365 SOC Monitoring!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.4 Security Monitoring for CompTIA Security+!'
