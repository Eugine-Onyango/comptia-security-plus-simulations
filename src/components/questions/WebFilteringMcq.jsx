...
const rawQuestions = [
  {
    id: 1,
    question: "When an employee clicks a malicious link, the corporate recursive resolver checks a real-time threat intelligence feed and refuses to resolve the IP address for the domain, preventing any connection from occurring. What security mechanism stopped the threat?",
    options: [
      { 
        text: "DNS Filtering", 
        isCorrect: true, 
    ...
    laymanExplanation: "DNS Filtering blocks bad sites at the phonebook step! Before your computer can open a website, it must look up its IP address via DNS. DNS filtering checks a threat list and refuses to give out bad IP addresses, stopping the attack instantly."
  },
  {
    id: 2,
    question: "An organization deploys an internal gateway server that intercepts all outbound HTTP/HTTPS requests from workstations, performs content scanning and URL checks, and fetches approved web pages on behalf of users. What component is being used?",
    options: [
      { 
        text: "Forward Proxy", 
        isCorrect: true, 
    ...
    laymanExplanation: "A Forward Proxy is an official middleman for outgoing web traffic! Users send web requests to the proxy, which scans the destination, retrieves the webpage, and hands it back to the user."
  },
  {
    id: 3,
    question: "A company requires strict URL category blocking to remain active on remote employee laptops even when workers connect to untrusted public Wi-Fi networks at coffee shops without turning on their VPN. What solution must be deployed?",
    options: [
      { 
        text: "Agent-Based Web Filtering", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Agent-based filtering travels with the laptop! By installing a lightweight software agent directly onto employee computers, web security rules are enforced anywhere they travel."
  },
  {
    id: 4,
    question: "A web security gateway automatically blocks access to a newly created website because automated intelligence engines assigned it a 'High Risk' dynamic threat score based on domain age and host history. What filtering method was applied?",
    options: [
      { 
        text: "Reputation-Based Web Filtering", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Reputation filtering acts like a credit score for websites! Even if a website is brand-new and not on a blocklist yet, a bad reputation score triggers an automatic block."
  },
  {
    id: 5,
    question: "A network administrator configures web security controls to ALLOW educational research sites, ALLOW AND ALERT on recreational shopping, and BLOCK online gambling domains. What filtering strategy is being utilized?",
    options: [
      { 
        text: "Category-Based URL Filtering (Dispositions)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not a web category filtering rule." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not URL category dispositions." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not a URL category disposition." 
      }
    ],
    laymanExplanation: "Category filtering groups millions of sites into topics! Instead of blocking websites one by one, you apply rules (dispositions) to whole categories like 'Gambling' or 'Shopping'."
  },
  {
    id: 6,
    question: "All outbound web traffic from user computers is automatically redirected and inspected by an inline network gateway without requiring any manual browser proxy configuration or client software setup. What type of proxy is running?",
    options: [
      { 
    ...
    laymanExplanation: "Transparent proxies work invisibly! They sit directly in the network traffic path and intercept web requests automatically without needing any browser setup."
  }
];
...
export default function WebFilteringMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.5 - Web Filtering Practice 🌐
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering DNS Filtering, Forward Proxies, Agent-Based Endpoint Filtering, Reputation Scoring, Category Dispositions, and Transparent Proxies!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.5 Web Filtering for CompTIA Security+!'
