...
const rawQuestions = [
  {
    id: 1,
    question: "A company's HR database stores sensitive employee salary data. To prevent unauthorized disclosure, the IT team enforces AES-256 database encryption, role-based access controls, and multi-factor authentication (MFA). Which pillar of the CIA Triad is directly protected?",
    options: [
      { 
      ...
      { 
        text: "SQL Injection", 
        isCorrect: false, 
        whyWrong: "SQL Injection is a web database attack technique, not a security goal." 
      },
      { 
        text: "Typosquatting", 
        isCorrect: false, 
    ...
    laymanExplanation: "Confidentiality is all about keeping secrets secret! Encryption, access controls, and passwords ensure that only authorized eyes can read sensitive information."
  },
  {
    id: 2,
    question: "A system administrator downloads a critical OS firmware update from a vendor server. Before installing, the administrator calculates the SHA-256 checksum hash of the file and matches it against the published hash to ensure no malicious code was injected in transit. Which CIA Triad principle is verified?",
    options: [
      { 
        text: "Integrity", 
        isCorrect: true, 
    ...
    laymanExplanation: "Integrity guarantees that your data hasn't been altered or tampered with! Hashing and digital signatures prove that a file is exact and untampered."
  },
  {
    id: 3,
    question: "An e-commerce platform installs redundant power supplies, RAID-1 mirrored hard drives, and automated load balancers so that online shopping remains operational even if a power unit or hard drive fails completely. Which CIA Triad component is maintained?",
    options: [
      { 
        text: "Availability", 
        isCorrect: true, 
    ...
    laymanExplanation: "Availability ensures that services and data are always ready when authorized users need them! Redundant hardware, fault tolerance, and load balancing keep systems up 24/7."
  },
  {
    id: 4,
    question: "An executive signs a high-value purchase agreement using a PKI digital certificate. The signature mathematically binds the signer's identity to the exact file content, preventing the executive from claiming they never signed it. What security property is provided?",
    options: [
      { 
    ...
    laymanExplanation: "Non-repudiation means 'No take-backs!' A digital signature provides indisputable proof that you sent or signed a document, so you cannot deny it later."
  },
  {
    id: 5,
    question: "In a hospital Emergency Room patient monitoring network, medical systems prioritize uptime above all else so doctors can access vital signs instantly during trauma care, rearranging the traditional CIA security order. What acronym represents this availability-first prioritization?",
    options: [
      { 
        text: "The AIC Triad (Availability, Integrity, Confidentiality)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not a security triad arrangement." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not security triad prioritization." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not a security triad." 
      }
    ],
    laymanExplanation: "The AIC Triad flips the letters to put Availability FIRST! In life-critical systems like hospital ERs or power grids, keeping systems running (Availability) is the top priority."
  },
  {
    id: 6,
    question: "An IT department establishes a monthly patch management schedule to deploy vendor updates, closing known security vulnerabilities and fixing system crash bugs. Which two CIA Triad goals are directly enhanced by routine software patching?",
    options: [
      { 
        text: "Availability (stability) and Integrity (closing exploit holes)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Patching fixes bugs to prevent crashes (boosting Availability) and seals security vulnerabilities so hackers can't tamper with data (protecting Integrity)!"
  }
];
...
export default function CiaTriadMcq({ onBack }) {
  ...
  return (
    <div class="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* Header Banner */}
      <div class="bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            1.2 - The CIA Triad Practice 🔐
          </h1>
          <p class="text-amber-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Confidentiality, Integrity, Availability, Hashing, Digital Signatures, Non-Repudiation, Redundancy, and the AIC Triad!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 1.2 The CIA Triad for CompTIA Security+!'
