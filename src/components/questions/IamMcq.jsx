...
const rawQuestions = [
  {
    id: 1,
    question: "When a software engineer resigns from a company, HR notifies IT to immediately revoke their digital credentials, cloud accounts, and VPN access. What IAM lifecycle process ensures access is revoked upon job separation?",
    options: [
      { 
        text: "Account De-provisioning", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "De-provisioning is digital offboarding! When someone leaves a company, de-provisioning immediately turns off their keys so former employees cannot log back into company systems."
  },
  {
    id: 2,
    question: "Before issuing a new remote worker their initial network credentials, HR requires them to join a video call and present an official government passport alongside official tax documents to verify their identity. What stage of identity proofing is being conducted?",
    options: [
      { 
        text: "Identity Verification / Attestation", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Identity Verification (Attestation) checks real-world proof! Before creating a computer account for a stranger, you inspect real documents (like a passport) to prove they are really who they say they are."
  },
  {
    id: 3,
    question: "An organization implements an IAM portal that allows employees to log in once at the start of their shift and automatically gain access to cloud email, HR portals, and file shares without being prompted for passwords again. What technology is used?",
    options: [
      { 
    ...
    laymanExplanation: "Single Sign-On (SSO) is one master key for all your apps! You log in once in the morning, and SSO unlocks all your authorized work apps without forcing you to re-type passwords."
  },
  {
    id: 4,
    question: "An IT admin needs to grant 30 new financial analysts access to the quarterly accounting folder. Rather than setting permissions for each individual user, the admin places all 30 accounts into an 'Finance_Users' group and assigns permissions to the group. What principle is applied?",
    options: [
      { 
        text: "Group-based Role Permission Assignment (Least Privilege)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Group permissions simplify access control! Instead of managing 30 separate users, you give permissions to a group and drop users inside, ensuring everyone gets just enough access for their job role."
  },
  {
    id: 5,
    question: "A company security policy mandates that employees perform daily web browsing and document editing using standard user accounts rather than Administrator accounts. What is the primary security goal of this rule?",
    options: [
      { 
        text: "Preventing malware executing under standard accounts from making system-wide administrative changes", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not standard account security." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not standard account security." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not standard account security." 
      }
    ],
    laymanExplanation: "Limiting daily accounts stops malware in its tracks! If you browse the web as an Administrator, viruses get Admin powers. Standard accounts restrict what viruses can touch."
  },
  {
    id: 6,
    question: "An external auditor requires an enterprise to produce quarterly records tracking all active digital identities, their current resource access levels, and historical permission changes for compliance. What IAM function satisfies this request?",
    options: [
      { 
        text: "Identity Governance & Access Auditing", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Identity Governance keeps an audit log of who has access to what! It tracks all user permissions over time to prove to regulators that company data is locked down."
  }
];
...
export default function IamMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white font-extrabold text-xs backdrop-blur-md mb-2">
            <span>CompTIA Security+ SY0-701 • Section 4.6</span>
          </div>
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.6 - Identity & Access Management Practice 🔑
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Provisioning / De-provisioning, Identity Proofing, Single Sign-On (SSO), Group Permission Assignments, and Identity Governance!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.6 Identity and Access Management for CompTIA Security+!'
