...
const rawQuestions = [
  {
    id: 1,
    question: "An enterprise decommissions 100 magnetic hard disk drives (HDDs) containing sensitive client files. Before sending the hardware to a recycler, what process exposes the drives to a powerful electromagnetic field, neutralizing all magnetic alignment and rendering the data permanently unrecoverable?",
    options: [
      { 
        text: "Electromagnetic Degaussing", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Degaussing uses a super-strong magnet! It completely wipes out the magnetic domains on spinning hard drives, instantly scrambling all stored data beyond any recovery while also destroying the drive motor."
  },
  {
    id: 2,
    question: "A hospital contracts a certified 3rd-party vendor to physically shred retired server drives offsite. To satisfy HIPAA regulatory compliance audits, what legal document must the vendor provide to confirm the exact serial numbers destroyed?",
    options: [
      { 
    ...
    laymanExplanation: "A Certificate of Destruction is your legal paper trail! It officially proves to auditors that specific drive serial numbers were physically destroyed by a certified disposal company."
  },
  {
    id: 3,
    question: "An IT department attaches scannable barcodes and RFID stickers to 500 new laptops and core network switches to log device ownership, serial numbers, and physical location in a centralized CMDB database. What are these stickers called?",
    options: [
      { 
        text: "Asset Tags", 
        isCorrect: true, 
    ...
    laymanExplanation: "Asset Tags are unique tracking labels! By sticking barcodes or RFID asset tags on hardware, IT can quickly scan and track who owns each laptop and where switches are located."
  },
  {
    id: 4,
    question: "Because Solid-State Drives (SSDs) and flash memory chips store data electronically and are immune to magnetic degaussers, what physical disposal method guarantees zero possibility of forensic data extraction by grinding the chips into micro-particles?",
    options: [
      { 
        text: "Shredding / Pulverizing", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Magnets don't work on SSD flash chips! For flash drives and SSDs, heavy industrial shredders and pulverizers grind the microchips into tiny powder fragments."
  },
  {
    id: 5,
    question: "An IT auditor categorizes physical rack servers and switches as long-term Capital Expenditures (CapEx), while software license subscriptions and cloud services are logged as Operating Expenditures (OpEx). What asset management phase is this?",
    options: [
      { 
        text: "Asset Accounting and Classification", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not asset accounting." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not asset classification." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not financial asset classification." 
      }
    ],
    laymanExplanation: "Asset Classification separates physical gear from software costs! Hardware is logged as CapEx (purchased capital equipment), while software subscriptions are logged as OpEx (ongoing operating expenses)."
  },
  {
    id: 6,
    question: "A bank's legal department mandates that all employee email archives and financial transaction ledgers must be retained in immutable backup storage for 7 years to meet federal financial regulations. What policy is being executed?",
    options: [
      { 
    ...
    laymanExplanation: "Data Retention rules dictate how long data must be kept! Laws often require companies to preserve emails and financial records for a set period (like 7 years) before purging them."
  }
];
...
export default function AssetManagementMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white font-extrabold text-xs backdrop-blur-md mb-2">
            <span>CompTIA Security+ SY0-701 • Section 4.2</span>
          </div>
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.2 - Asset Management Practice 📦
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Procurement, Asset Tagging/RFID, Degaussing, Physical Shredding, Certificates of Destruction, and Data Retention!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.2 Asset Management for CompTIA Security+!'
