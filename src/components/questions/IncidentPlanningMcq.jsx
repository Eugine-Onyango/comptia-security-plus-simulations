...
const rawQuestions = [
  {
    id: 1,
    question: "Before a real cyberattack occurs, an organization gathers its CISO, network engineers, legal counsel, and HR director around a conference table to verbally walk through a simulated ransomware scenario. No production systems are touched, and the team evaluates their response plan through discussion only. What type of exercise is conducted?",
    options: [
      { 
      ...
      { 
        text: "SQL Injection", 
        isCorrect: false, 
        whyWrong: "SQL injection is a web database attack technique, not an incident planning exercise." 
      },
      { 
        text: "RF Jamming", 
        isCorrect: false, 
        whyWrong: "RF Jamming floods radio frequencies with noise to disrupt wireless signals." 
      },
      { 
        text: "Typosquatting", 
        isCorrect: false, 
    ...
    laymanExplanation: "A Tabletop Exercise is like a board game rehearsal for emergencies! Key players sit around a table and TALK through 'what would we do if...' scenarios without actually touching any real computers or networks."
  },
  {
    id: 2,
    question: "A security team creates a fake phishing email mimicking an urgent password reset request from the CEO and sends it to 500 employees. The team tracks who clicks the link, who reports it, and whether the email filter catches it. Employees who fail receive mandatory security awareness training. What testing method is used?",
    options: [
      { 
        text: "Simulation (Phishing Simulation Test)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "A Simulation is a LIVE fire drill! Unlike tabletop exercises where people just talk, simulations actually send fake phishing emails to real employees to test both the security filters AND user awareness."
  },
  {
    id: 3,
    question: "After a data breach, an investigation team systematically asks 'WHY did this happen?' at each level. They discover the firewall rule was misconfigured, but also find that the change management process failed to require peer review. The team documents multiple contributing factors rather than blaming a single cause. What analysis method is used?",
    options: [
      { 
    ...
    laymanExplanation: "Root Cause Analysis is detective work that keeps asking 'but WHY?' until you find the real reason! Don't get tunnel vision — there's often more than one root cause, and mistakes happen. What matters is the response to the mistake."
  },
  {
    id: 4,
    question: "A cybersecurity analyst proactively searches through network logs and endpoint telemetry data looking for hidden indicators of compromise BEFORE any alert fires. The analyst uses behavioral analytics and threat intelligence feeds to find attackers who may already be inside the network undetected. What proactive security activity is described?",
    options: [
      { 
        text: "Threat Hunting", 
        isCorrect: true, 
    ...
    laymanExplanation: "Threat Hunting is a proactive game of cat and mouse! Instead of waiting for alarms to ring, hunters actively search for hidden attackers. Intelligence data is reactive — you can't see the attack until it happens — so threat hunters use technology to speed up reaction time."
  },
  {
    id: 5,
    question: "An organization schedules an annual incident response drill with well-defined rules: the scenario is specific (simulated insider data theft), the exercise has a strict 2-hour time limit, production systems are NOT touched, and the team documents and discusses their response afterwards. What governance element structures this exercise?",
    options: [
      { 
        text: "Rules of Engagement for Exercising", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric unrelated to incident planning." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not incident exercise governance." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not an exercise governance framework." 
      }
    ],
    laymanExplanation: "Rules of Engagement are the ground rules for practice drills! They define what can and can't be done during the exercise — like 'don't touch the live servers', 'you have 2 hours', and 'document everything you discuss'."
  },
  {
    id: 6,
    question: "A CISO must choose between two incident response preparation methods for a limited budget. Method A gathers key players in a room to verbally discuss a hypothetical data breach without executing any actions. Method B actively sends fake phishing emails and tests real security controls. What is the key difference between these methods?",
    options: [
      { 
        text: "Method A is a Tabletop (talk-only, cost-effective) while Method B is a Simulation (live testing of real controls)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Tabletop = talking through a pretend disaster around a table (cheap and easy). Simulation = actually doing it for real (sending fake phishing, triggering real alerts). Both prepare your team, but tabletops analyze logistics while simulations test real-world response!"
  }
];
...
export default function IncidentPlanningMcq({ onBack }) {
  ...
  return (
    <div class="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* Header Banner */}
      <div class="bg-gradient-to-r from-violet-600 via-purple-600 to-violet-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-violet-200/50 flex items-center justify-between gap-4">
        <div>
          ...
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.8 - Incident Planning Practice 📋
          </h1>
          <p class="text-violet-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Tabletop Exercises, Phishing Simulations, Root Cause Analysis, Threat Hunting, Rules of Engagement, and Tabletop vs Simulation!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.8 Incident Planning for CompTIA Security+!'
