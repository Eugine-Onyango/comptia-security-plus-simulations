...
const rawQuestions = [
  {
    id: 1,
    question: "A cloud security team deploys automated validation checks into a CI/CD deployment pipeline. If a developer attempts to deploy a virtual machine with public RDP access enabled, the pipeline automatically halts deployment and enforces corporate security policies. What automation concept provides these enforced safety boundaries?",
    options: [
      { 
        text: "Automated Guard Rails", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Guard rails act like automated safety bumpers! They continuously check your code and stop dangerous configurations before they go live."
  },
  {
    id: 2,
    question: "At 3:00 AM, a SIEM alert detects ransomware activity on an unattended workstation. Within 50 milliseconds, an automated SOAR script executes an API call to quarantine the infected host from the network without waiting for an analyst to wake up. What benefit of security automation is demonstrated?",
    options: [
      { 
        text: "Sub-second reaction time & workforce multiplier", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Computers don't sleep! Automated scripts react in milliseconds at 3 AM without typing errors, multiplying what your security team can handle 24/7."
  },
  {
    id: 3,
    question: "A company uses a single custom 2,000-line script to automate all user account provisioning. When a third-party Cloud API update breaks the script's code formatting, employee onboarding halts completely across all branches nationwide. What scripting risk occurred?",
    options: [
      { 
    ...
    laymanExplanation: "A single point of failure means if one script breaks, everything breaks! Relying entirely on one complex unbacked script creates operational vulnerability."
  },
  {
    id: 4,
    question: "During an emergency outage, an engineer writes a quick hardcoded script workaround to bypass a failing security check. Months later, the unmaintained script is forgotten, creating an expensive legacy vulnerability in production. What scripting risk is illustrated?",
    options: [
      { 
        text: "Technical Debt", 
        isCorrect: true, 
    ...
    laymanExplanation: "Technical debt happens when quick temporary band-aids are left in place! Quick hacks cause expensive security problems and refactoring costs down the road."
  },
  {
    id: 5,
    question: "A security team uses automated scripts and REST APIs to connect network firewalls, endpoint detection tools, and cloud platforms so they can communicate and respond to threats seamlessly in a single unified workflow. What process is described?",
    options: [
      { 
        text: "Orchestration & API Integration", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not Orchestration." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not Orchestration." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not Orchestration." 
      }
    ],
    laymanExplanation: "Orchestration conducts security tools like an orchestra! Using APIs, scripts connect firewalls, cloud logs, and endpoints so they work together automatically."
  },
  {
    id: 6,
    question: "An organization's automated baseline deployment script fails after an operating system vendor deprecates old command-line flags. The team realizes that automation requires continuous testing, documentation, and version tracking. What scripting consideration is highlighted?",
    options: [
      { 
        text: "Ongoing Supportability", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Ongoing supportability means keeping scripts maintained! As APIs and operating systems update, scripts need regular maintenance so they don't suddenly break."
  }
];
...
export default function ScriptingAutomationMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white font-extrabold text-xs backdrop-blur-md mb-2">
            <span>CompTIA Security+ SY0-701 • Section 4.7</span>
          </div>
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.7 - Scripting & Automation Practice 🤖
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Guard Rails, Reaction Speed, Single Point of Failure, Technical Debt, Orchestration APIs, and Supportability!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.7 Scripting & Automation for CompTIA Security+!'
