...
const rawQuestions = [
  {
    id: 1,
    question: "An organization hires an ethical hacking firm to simulate a real-world cyberattack against its e-commerce infrastructure. Unlike an automated vulnerability scanner, what primary action defines a penetration test?",
    options: [
      { 
        text: "Actively attempting to exploit identified vulnerabilities to breach systems and escalate privileges", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Pentesters actually break through the door! While vulnerability scanners only report that a door might be unlocked, a penetration test actively tries to open the door and break inside to prove a vulnerability is real."
  },
  {
    id: 2,
    question: "Before starting an external penetration test, the client and the ethical hacking team sign a contract defining allowed IP address ranges, permitted testing hours, out-of-scope production databases, and emergency contact numbers. What is this crucial document called?",
    options: [
      { 
    ...
    laymanExplanation: "The Rules of Engagement (RoE) is the legal rulebook! It strictly sets what systems testers can attack, what hours they can test, and what systems are completely off-limits so business operations aren't accidentally destroyed."
  },
  {
    id: 3,
    question: "A bank undergoes an annual third-party penetration test to fulfill PCI DSS regulatory compliance requirements. Which official publication provides the technical framework for information security testing and assessment?",
    options: [
      { 
    ...
    laymanExplanation: "NIST SP 800-115 is the gold standard testing guide! It outlines formal procedures for technical security assessments, penetration testing, and vulnerability analysis."
  },
  {
    id: 4,
    question: "During an active penetration testing assessment, a tester executes a buffer overflow exploit script against a legacy domain controller, causing the server to crash and triggering an unmanaged outage. Why is careful execution during pentesting critical?",
    options: [
      { 
        text: "Active exploitation carries high risk of causing system instability or denial of service (DoS)", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Real exploits can crash servers! Pentesters must be careful because aggressive exploit scripts can cause unexpected system crashes and take production servers offline."
  },
  {
    id: 5,
    question: "After successfully exploiting an unpatched web portal to gain low-privilege guest account shell access, a penetration tester runs a local exploit payload to gain root/administrator domain rights over the operating system. What step is occurring?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network timing metric, not access level elevation." 
      },
      { 
        text: "Disabling WPA3 enterprise encryption", 
        isCorrect: false, 
        whyWrong: "Disabling WPA3 affects Wi-Fi security, not host OS access levels." 
      },
      { 
        text: "Forcing CPU thermal throttling", 
        isCorrect: false, 
        whyWrong: "Thermal throttling is a hardware heat response, not access elevation." 
      }
    ],
    laymanExplanation: "Privilege Escalation levels up your access! Once inside a system as a basic user, privilege escalation exploits local bugs to jump up to root or domain administrator control."
  },
  {
    id: 6,
    question: "A penetration tester discovers a sub-domain belonging to a third-party cloud HR vendor used by the target company. The signed Rules of Engagement (RoE) explicitly list third-party cloud vendors as 'out-of-scope'. What should the tester do?",
    options: [
      { 
        text: "Immediately cease testing that sub-domain to abide by the RoE contract and legal scope", 
        isCorrect: true, 
        whyWrong: "" 
      },
      { 
    ...
    laymanExplanation: "Never attack out-of-scope targets! Attacking systems outside the agreed Rules of Engagement is illegal hacking, even during an authorized pentest."
  }
];
...
export default function PenetrationTestingMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-blue-200/50 flex items-center justify-between gap-4">
        <div>
          <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white font-extrabold text-xs backdrop-blur-md mb-2">
            <span>CompTIA Security+ SY0-701 • Section 4.3</span>
          </div>
          <h1 class="text-3xl font-extrabold tracking-tight">
            4.3 - Penetration Testing Practice ⚔️
          </h1>
          <p class="text-blue-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Active Exploitation, Rules of Engagement (RoE), NIST SP 800-115, System Instability Risks, Privilege Escalation, and Scope Boundaries!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-2xl max-w-md mx-auto text-blue-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 4.3 Penetration Testing for CompTIA Security+!'
