...
const rawQuestions = [
  {
    id: 1,
    question: "An organization installs Next-Generation Firewalls, host-based antivirus software, and automated OS access controls to protect sensitive cloud servers. Which security control category do these system-based technology implementations fall under?",
    options: [
      { 
      ...
      { 
        text: "SQL Injection", 
        isCorrect: false, 
        whyWrong: "SQL Injection is a database attack technique, not a security control category." 
      },
      { 
        text: "Typosquatting", 
        isCorrect: false, 
    ...
    laymanExplanation: "Technical controls are security protections built into computers, software, and network hardware! Firewalls, antivirus programs, and encryption algorithms are all technical controls."
  },
  {
    id: 2,
    question: "A company hires security guards to conduct manual credential checks at building entrances and mandates annual security awareness training for all employees. What control category applies to these human-driven operational processes?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Telnet transmits unencrypted data over port 23, which is an insecure protocol, not an operational control." 
      },
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Switching loops occur when duplicate switch connections create broadcast storms." 
      }
    ],
    laymanExplanation: "Operational controls are run by PEOPLE instead of software! Security guards patrolling the hallways and mandatory user security awareness training are human operational controls."
  },
  {
    id: 3,
    question: "A facility places a prominent warning sign at the perimeter fence stating 'WARNING: Restricted Area - Violators Will Be Prosecuted', and displays a legal splash screen on workstation logon screens. What functional control type is designed to discourage intruders before an attack?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "HVAC thermal shutdown turns off data center cooling systems to prevent heat damage." 
      },
      { 
    ...
    laymanExplanation: "Deterrent controls make an attacker think twice! They don't physically block the door, but warning signs and legal warning screens warn trespassers about severe consequences."
  },
  {
    id: 4,
    question: "A security system records server login reports, triggers automated motion detectors in data center aisles, and streams live CCTV security logs to a central SOC dashboard. What control type identifies and records security events during or after they occur?",
    options: [
      { 
    ...
    laymanExplanation: "Detective controls act like burglar alarms and security cameras! They spot and log intrusion attempts as they happen so security teams know an event occurred."
  },
  {
    id: 5,
    question: "Following a successful ransomware infection, an IT team wipes the compromised servers and restores all critical databases from clean, offline immutable backups. What control type is applied AFTER an incident to reverse damage and restore normal operations?",
    options: [
      { 
      ...
      { 
        ...
        isCorrect: false, 
        whyWrong: "Gigabit switch latency is a network speed metric, not a security control." 
      },
      { 
    ...
    laymanExplanation: "Corrective controls fix the damage AFTER a disaster! Restoring files from backups after a ransomware attack or using a fire extinguisher to put out a server fire are corrective controls."
  },
  {
    id: 6,
    question: "A critical legacy web application contains an unpatched vulnerability, but the vendor has not yet released a software fix. The security team configures a Web Application Firewall (WAF) rule to block traffic targeting that specific flaw until a patch is available. What control type provides this temporary alternative defense?",
    options: [
      { 
    ...
    laymanExplanation: "Compensating controls are backup workarounds! When you can't fix the main issue right away (like an unpatched app), a compensating control (like a firewall block rule) shields the system until the real fix arrives."
  }
];
...
export default function SecurityControlsMcq({ onBack }) {
      ...
      <div class="bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-amber-200/50 flex items-center justify-between gap-4">
        <div>
          <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white font-extrabold text-xs backdrop-blur-md mb-2">
            <span>CompTIA Security+ SY0-701 • Section 1.1</span>
          </div>
          <h1 class="text-3xl font-extrabold tracking-tight">
            1.1 - Security Controls Practice 🛡️
          </h1>
          <p class="text-amber-100 font-medium text-sm mt-1">
            CompTIA Security+ scenario questions covering Technical, Managerial, Operational, Physical categories and Preventive, Deterrent, Detective, Corrective, Compensating & Directive control types!
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 border-2 border-slate-200 shadow-sm text-center space-y-6 animate-fadeIn">
          ...
          <div class="p-4 bg-amber-50 border border-amber-200 rounded-2xl max-w-md mx-auto text-amber-950 text-sm font-semibold">
            {score === questions.length 
              ? '🌟 PERFECT SCORE! You have mastered 1.1 Security Controls for CompTIA Security+!'
