...
import CertificatesMcq from './components/questions/CertificatesMcq';
...
import Domain5DumpsBatch4Mcq from './components/questions/Domain5DumpsBatch4Mcq';
...
import Domain5DumpsBatch9Mcq from './components/questions/Domain5DumpsBatch9Mcq';
import Domain5DumpsBatch10Mcq from './components/questions/Domain5DumpsBatch10Mcq';
import Domain5DumpsBatch11Mcq from './components/questions/Domain5DumpsBatch11Mcq';
    ...
    <div class="min-h-screen flex flex-col bg-amber-50/40 text-slate-800">
      ...
      <main class="flex-1 pb-16">
        ...
        {currentView === 'command_drills' && (
          <CommandMasterStudioSim onBack={() => setCurrentView('home')} />
        )}
        ...
        {currentView === 'prepset_domain1' && (
          <Domain1PrepSetMcq onBack={() => setCurrentView('home')} />
        )}
        ...
        {currentView === 'exam_bank' && (
          <ExamBankPage
            ...
            onSelectBatch={(batchId) => {
              ...
              if (batchId === 'domain5_dumps_batch4') setCurrentView('domain5_dumps_batch4');
              ...
              if (batchId === 'domain5_dumps_batch9') setCurrentView('domain5_dumps_batch9');
              if (batchId === 'domain5_dumps_batch10') setCurrentView('domain5_dumps_batch10');
              if (batchId === 'domain5_dumps_batch11') setCurrentView('domain5_dumps_batch11');
            }}
          />
        )}
        ...
        {currentView === 'domain1' && (
          <Domain1Page
            ...
            onSelectTopic={(topicId) => {
              ...
              if (topicId === 'certificates_mcq') setCurrentView('certificates_mcq');
            }}
          />
        )}
        ...
        {currentView === 'physical_security_mcq' && (
          <PhysicalSecurityMcq
            onBack={() => setCurrentView('domain1')}
          />
        )}
        ...
        {currentView === 'technical_change_management_mcq' && (
          <TechnicalChangeManagementMcq
            onBack={() => setCurrentView('domain1')}
          />
        )}
        ...
        {currentView === 'domain5_dumps_batch4' && (
          <Domain5DumpsBatch4Mcq
            onBack={() => setCurrentView('exam_bank')}
          />
        )}

        {currentView === 'domain5_dumps_batch5' && (
          <Domain5DumpsBatch5Mcq
            onBack={() => setCurrentView('exam_bank')}
          />
        )}

        {currentView === 'domain5_dumps_batch6' && (
          <Domain5DumpsBatch6Mcq
            onBack={() => setCurrentView('exam_bank')}
          />
        )}
        ...
        {currentView === 'domain5_dumps_batch9' && (
          <Domain5DumpsBatch9Mcq
            onBack={() => setCurrentView('exam_bank')}
          />
        )}

        {currentView === 'domain5_dumps_batch10' && (
          <Domain5DumpsBatch10Mcq
            onBack={() => setCurrentView('exam_bank')}
          />
        )}

        {currentView === 'domain5_dumps_batch11' && (
          <Domain5DumpsBatch11Mcq
            onBack={() => setCurrentView('exam_bank')}
          />
        )}
      </main>
